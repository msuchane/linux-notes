...
By default, clicking the middle mouse button pastes text from the _primary clipboard_. This is usually confusing to people who haven't been using Linux since 2000. Disable this behavior.

. Install GNOME Tweaks, available from the `gnome-tweaks` package on Fedora, Debian, and Ubuntu.
