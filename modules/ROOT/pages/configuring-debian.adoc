...
== Install multimedia support [[debian-multimedia]]
...
sudo apt install \
  ...
  libva-drm1 libva-egl1 libva-intel-vaapi-driver \
  libva1 libvdpau-va-gl1 libvdpau1
----


== Enable Flatpak

By deault, Debian doesn't enable Flatpak, but its GNOME desktop does come with an app store where you can manage Flatpak applications. Install what's missing. See link:https://flathub.org/en/setup/Debian[Debian Flathub Setup].
