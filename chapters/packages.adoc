...
To have access to all packages listed here, enable the https://rpmfusion.org/[RPM Fusion] Free and Nonfree repositories. Follow their instructions on the https://rpmfusion.org/Configuration[Configuration] page.
